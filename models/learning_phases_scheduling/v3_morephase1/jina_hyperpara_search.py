...
Model outputs (for multiple hyperparameter experiments) will be saved in:
  /home/chb3333/yulab/chb3333/gem-patho/models/learning_phases_scheduling/v3_morephase1
"""
...
BASE_OUTPUT_DIR = "/home/chb3333/yulab/chb3333/gem-patho/models/learning_phases_scheduling/v3_morephase1"
NUM_FOLDS = 10
...
def main():
    ...
    experiments = [
        {"transition_percentage": 0.9, "final_percentage": 0.8, "warmup": 10, "transition": 10},
        {"transition_percentage": 0.9, "final_percentage": 0.8, "warmup": 15, "transition": 15},
