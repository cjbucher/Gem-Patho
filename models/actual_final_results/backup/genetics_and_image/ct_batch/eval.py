...
This script is adapted from your all_batch evaluation script but updated to load models 
from the ct_batch directory and to use the original (all_batch-style) dataset which returns case IDs.
"""
...
# Update BASE_OUTPUT_DIR to your ct_batch directory
BASE_OUTPUT_DIR = "/home/chb3333/yulab/chb3333/gem-patho/models/actual_final_results/genetics_and_image/ct_batch"
NUM_FOLDS = 10
...
def collate_fn_preprocessed(batch):
    # Unpack list of tuples (including image features and case IDs).
