...
Model outputs (for multiple hyperparameter experiments) will be saved in:
  /n/data2/hms/dbmi/kyu/lab/chb3333/gem-patho/models/actual_final_results/only_genetics/ct_batch
"""
...
def evaluate_model(model, dataloader, device):
    ...
    with torch.no_grad():
        for emb_batch, score_batch, cna_batch, cancer_type_batch, desc_batch, T_batch, E_batch, case_ids in dataloader:
            ...
            # Convert cancer type binary vector to an integer index.
            ct_idx_list = []
    ...
    # Now return all 10 values (including all_E)
