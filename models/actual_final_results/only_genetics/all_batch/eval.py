...
##########################################
# Collate Function (for genetic-only data)
##########################################
def collate_fn_preprocessed(batch):
    # Unpack list of tuples (without image features).
...
##########################################
# Dataset for Preprocessed Sequences (Genetic Data Only)
##########################################
...
##########################################
# Transformer Survival Model (Genetic-Only)
##########################################
...
def main():
    ...
    parser.add_argument("--exp_folder", type=str, default="cancertypebatching_exp_1_phase2_0",
                        help="Experiment folder name (e.g., cancertypebatching_exp_1_phase2_0)")
