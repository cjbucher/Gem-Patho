...
Base output directory: /home/chb3333/yulab/chb3333/gem-patho/models/clean_baseline_results/pure_genetics/one_hot_encoded
...
BASE_OUTPUT_DIR = "/home/chb3333/yulab/chb3333/gem-patho/models/clean_baseline_results/pure_genetics/one_hot_encoded"
NUM_FOLDS = 10
...
##########################################
# Main Function: Evaluate Models Per Cancer Type
##########################################
def main():
    parser = argparse.ArgumentParser(description="Compute test risk scores from the best genetic-only model and calculate per-cancer-type c-indices.")
    ...
    for fold in range(1, NUM_FOLDS+1):
        ...
        fold_save_dir = os.path.join(BASE_OUTPUT_DIR, f"fold_{fold}")
        ...
        # Assume the test file contains: Case ID, polyphen_score, gene_embed_seq, OS.time, OS, type.
        ...
        model_path = os.path.join(BASE_OUTPUT_DIR, f"fold_{fold}", "best_model.pth")
    ...
    if all_test_dfs:
        ...
        # Use normalized risk scores for c-index computation.
        ...
        ct_summary_path = os.path.join(BASE_OUTPUT_DIR, "global_test_cindices.csv")
